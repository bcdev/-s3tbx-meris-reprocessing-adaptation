package org.esa.s3tbx.meris.reprocessing;

import org.esa.snap.core.datamodel.Product;

/**
 * Interface for adaptation of reprocessed L1 source data (here i.e. MERIS 3rd <--> 4th reprocessing)
 * todo: move this to a more general place in SNAP
 *
 */
